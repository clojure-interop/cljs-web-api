...
var or__41385__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj49358 = {"detail":data};
return obj49358;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__41373__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__41373__auto__)){
var and__41373__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__49365 = cljs.core._EQ_;
var expr__49366 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__49365.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__49366))){
return ((function (pred__49365,expr__49366){
return (function (p1__49359_SHARP_){
return console.warn(p1__49359_SHARP_);
});
;})(pred__49365,expr__49366))
} else {
if(cljs.core.truth_(pred__49365.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__49366))){
return ((function (pred__49365,expr__49366){
return (function (p1__49360_SHARP_){
return console.debug(p1__49360_SHARP_);
});
;})(pred__49365,expr__49366))
} else {
if(cljs.core.truth_(pred__49365.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__49366))){
return ((function (pred__49365,expr__49366){
return (function (p1__49361_SHARP_){
return console.error(p1__49361_SHARP_);
});
;})(pred__49365,expr__49366))
} else {
return ((function (pred__49365,expr__49366){
return (function (p1__49362_SHARP_){
return console.log(p1__49362_SHARP_);
});
;})(pred__49365,expr__49366))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__49369){
...
var opts = map__49370__$1;
var eval_fn = cljs.core.get.call(null,map__49370__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__49372_SHARP_);
});})(new_def))
);
...
return (function (p__49373){
var vec__49374 = p__49373;
var ky = cljs.core.nth.call(null,vec__49374,(0),null);
var v = cljs.core.nth.call(null,vec__49374,(1),null);
...
if(cljs.core.truth_((function (){var and__41373__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1565798834253
