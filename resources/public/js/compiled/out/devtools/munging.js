...
var o53262 = temp__4655__auto__;
var temp__4655__auto____$1 = (o53262["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o53263 = temp__4655__auto____$1;
return (o53263["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__53190__auto__ = f;
return (o__53190__auto__["toString"]).call(o__53190__auto__);
} else {
return "";
}
}catch (e53264){var _ = e53264;
return "";
}});
...
try{var o__53190__auto___53266 = t;
(o__53190__auto___53266["cljs$lang$ctorPrWriter"]).call(o__53190__auto___53266,t,writer);
}catch (e53265){var __53267 = e53265;
}
...
var char_code = (function (){var o__53190__auto__ = (new String(char$));
return (o__53190__auto__["charCodeAt"]).call(o__53190__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__53190__auto__ = String;
return (o__53190__auto__["fromCharCode"]).call(o__53190__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__53268 = num_code;
switch (G__53268) {
case (1):
return (185);
...
var o__53190__auto__ = String;
return (o__53190__auto__["fromCharCode"]).call(o__53190__auto__,superscript_code);
});
/**
...
}catch (e53270){var _e__53197__auto__ = e53270;
return false;
}})())){
...
var vec__53271 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__53271,(0),null);
...
var or__41385__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4655__auto__)){
var o53274 = temp__4655__auto__;
var temp__4655__auto____$1 = (o53274["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o53275 = temp__4655__auto____$1;
return (o53275["nameToPath"]);
} else {
return null;
}
} else {
...
var len__42556__auto___53282 = arguments.length;
var i__42557__auto___53283 = (0);
while(true){
if((i__42557__auto___53283 < len__42556__auto___53282)){
args__42563__auto__.push((arguments[i__42557__auto___53283]));

var G__53284 = (i__42557__auto___53283 + (1));
i__42557__auto___53283 = G__53284;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__42564__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__53278){
var vec__53279 = p__53278;
var ns_detector = cljs.core.nth.call(null,vec__53279,(0),null);
var effective_detector = (function (){var or__41385__auto__ = ns_detector;
if(cljs.core.truth_(or__41385__auto__)){
return or__41385__auto__;
} else {
...
var G__53285 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__53286 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__53285;
remaining_tokens = G__53286;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq53276){
var G__53277 = cljs.core.first.call(null,seq53276);
var seq53276__$1 = cljs.core.next.call(null,seq53276);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__53277,seq53276__$1);
});
...
var vec__53290 = cljs.core.split_with.call(null,(function (p1__53289_SHARP_){
return cljs.core.not_EQ_.call(null,p1__53289_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__53290,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__53290,(1),null);
...
var vec__53293 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__53293,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__53293,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__53296 = cljs.core.rest.call(null,remaining_tokens);
var G__53297 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__53296;
name_tokens = G__53297;
continue;
} else {
...
var vec__53300 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__53300,(0),null);
var arity = cljs.core.nth.call(null,vec__53300,(1),null);
var vec__53303 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__53303,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__53303,(1),null);
var vec__53306 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__53306,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__53306,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__53306,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__53306,(3),null);
...
var vec__53312 = result;
var munged_ns = cljs.core.nth.call(null,vec__53312,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__53312,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__53312,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__53312,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__53312,(4),null);
var arity = cljs.core.nth.call(null,vec__53312,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__53316 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__53316,(0),null);
var args = cljs.core.nth.call(null,vec__53316,(1),null);
var vec__53319 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__53319,(0),null);
var name = cljs.core.nth.call(null,vec__53319,(1),null);
...
var G__53322 = (arity + (1));
var G__53323 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__53324){
var vec__53325 = p__53324;
var arity = cljs.core.nth.call(null,vec__53325,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__53325,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__41385__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__41385__auto__)){
return or__41385__auto__;
} else {
...
return (function (p1__53328_SHARP_){
return cljs.core.get.call(null,arities,p1__53328_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__53329_SHARP_);
...
var args__42563__auto__ = [];
var len__42556__auto___53336 = arguments.length;
var i__42557__auto___53337 = (0);
while(true){
if((i__42557__auto___53337 < len__42556__auto___53336)){
args__42563__auto__.push((arguments[i__42557__auto___53337]));

var G__53338 = (i__42557__auto___53337 + (1));
i__42557__auto___53337 = G__53338;
continue;
} else {
}
break;
...
var argseq__42564__auto__ = ((((1) < args__42563__auto__.length))?(new cljs.core.IndexedSeq(args__42563__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__42564__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__53332){
var vec__53333 = p__53332;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__53333,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq53330){
var G__53331 = cljs.core.first.call(null,seq53330);
var seq53330__$1 = cljs.core.next.call(null,seq53330);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__53331,seq53330__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__41385__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__41385__auto__)){
return or__41385__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__41373__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__41385__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__41385__auto__)){
return or__41385__auto__;
} else {
...
var map__53341 = options;
var map__53341__$1 = ((((!((map__53341 == null)))?((((map__53341.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53341.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53341):map__53341);
var include_ns_QMARK_ = cljs.core.get.call(null,map__53341__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__53341__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__53341__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__53341__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__53342 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__53342,(0),null);
var fn_name = cljs.core.nth.call(null,vec__53342,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__53342,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__53342,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__53342,(4),null);
var arity = cljs.core.nth.call(null,vec__53342,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__41373__auto__ = protocol_ns;
if(cljs.core.truth_(and__41373__auto__)){
return cljs.core.not.call(null,(function (){var and__41373__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__41385__auto__ = protocol_part;
if(cljs.core.truth_(or__41385__auto__)){
return or__41385__auto__;
} else {
return fn_part;
...
var o__53190__auto__ = f;
return (o__53190__auto__["getBasis"]).call(o__53190__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__41373__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__41373__auto__)){
...
}catch (e53346){var _e__53197__auto__ = e53346;
...
var G__53347 = (obj[cljs.core.first.call(null,path)]);
var G__53348 = cljs.core.rest.call(null,path);
obj = G__53347;
path = G__53348;
continue;
} else {
...
var partition_bits = (function (){var or__41385__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__41385__auto__)){
return or__41385__auto__;
} else {
return (0);
...
return (function (accum,p__53349){
var vec__53350 = p__53349;
var bit = cljs.core.nth.call(null,vec__53350,(0),null);
var protocol = cljs.core.nth.call(null,vec__53350,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__53353){
var vec__53354 = p__53353;
var ns = cljs.core.nth.call(null,vec__53354,(0),null);
var name = cljs.core.nth.call(null,vec__53354,(1),null);
var selector = cljs.core.nth.call(null,vec__53354,(2),null);
...
return (function (p__53358){
var vec__53359 = p__53358;
var munged_name = cljs.core.nth.call(null,vec__53359,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__53359,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__53359,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__53357_SHARP_){
return (obj[cljs.core.first.call(null,p1__53357_SHARP_)]);
});})(name,sorted_matches,vec__53359,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1565798864014
