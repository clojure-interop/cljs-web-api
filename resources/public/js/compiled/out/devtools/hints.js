...
var reader = (function (){var or__41385__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
devtools.hints.mark_null_call_site_location = (function devtools$hints$mark_null_call_site_location(file__$1,line_number,column){
var content = devtools.hints.retrieve_javascript_source.call(null,file__$1);
...
var min_length = (function (){var or__41385__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__41385__auto__)){
return or__41385__auto__;
} else {
return (128);
...
devtools.hints.make_sense_of_the_error = (function devtools$hints$make_sense_of_the_error(message,file__$1,line_number,column){
if(cljs.core.truth_(cljs.core.re_matches.call(null,/Cannot read property 'call' of.*/,message))){
return devtools.hints.mark_null_call_site_location.call(null,file__$1,line_number,column);
} else {
return null;
...
var map__55943 = top_item;
var map__55943__$1 = ((((!((map__55943 == null)))?((((map__55943.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55943.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__55943):map__55943);
var file__$1 = cljs.core.get.call(null,map__55943__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__55943__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__55943__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file__$1,line,column);
}catch (e55942){var _e = e55942;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___55945 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___55945)){
var seen_errors_55946 = temp__4655__auto___55945;
if(cljs.core.truth_(seen_errors_55946.has(self))){
} else {
seen_errors_55946.add(self);

var temp__4657__auto___55947 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___55947)){
var sense_55948 = temp__4657__auto___55947;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_55948)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1565798879445
