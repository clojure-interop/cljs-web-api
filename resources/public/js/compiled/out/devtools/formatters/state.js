...
var len__42556__auto___54170 = arguments.length;
var i__42557__auto___54171 = (0);
while(true){
if((i__42557__auto___54171 < len__42556__auto___54170)){
args__42563__auto__.push((arguments[i__42557__auto___54171]));

var G__54172 = (i__42557__auto___54171 + (1));
i__42557__auto___54171 = G__54172;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__42564__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq54168){
var G__54169 = cljs.core.first.call(null,seq54168);
var seq54168__$1 = cljs.core.next.call(null,seq54168);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__54169,seq54168__$1);
});
...
return (p1__54173_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1565798865498
