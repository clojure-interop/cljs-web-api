...
var and__41373__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__41373__auto__){
var or__41385__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e55736){var _e__53197__auto__ = e55736;
return false;
...
}catch (e55738){var _e__53197__auto__ = e55738;
return false;
...
}catch (e55740){var _e__53197__auto__ = e55740;
return false;
...
}catch (e55742){var _e__53197__auto__ = e55742;
return false;
...
}catch (e55744){var _e__53197__auto__ = e55744;
return false;
}})())){
...
}catch (e55746){var _e__53197__auto__ = e55746;
return false;
}})())){
...
var _STAR_current_state_STAR_55748 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__41385__auto__ = config;
if(cljs.core.truth_(or__41385__auto__)){
return or__41385__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_55748;
}});
});
...
return (function() { 
var G__55750__delegate = function (args){
try{return cljs.core.apply.call(null,f,args);
}catch (e55749){var e = e55749;
devtools.reporter.report_internal_error_BANG_.call(null,e,"an exception was raised during value formatting");

return null;
}};
var G__55750 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__55751__i = 0, G__55751__a = new Array(arguments.length -  0);
while (G__55751__i < G__55751__a.length) {G__55751__a[G__55751__i] = arguments[G__55751__i + 0]; ++G__55751__i;}
  args = new cljs.core.IndexedSeq(G__55751__a,0,null);
} 
return G__55750__delegate.call(this,args);};
G__55750.cljs$lang$maxFixedArity = 0;
G__55750.cljs$lang$applyTo = (function (arglist__55752){
var args = cljs.core.seq(arglist__55752);
return G__55750__delegate(args);
});
G__55750.cljs$core$IFn$_invoke$arity$variadic = G__55750__delegate;
return G__55750;
})()
;
});
...
var pre_handler = (function (){var or__41385__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__41385__auto__)){
return or__41385__auto__;
} else {
...
var post_handler = (function (){var or__41385__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__41385__auto__)){
return or__41385__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1565798877848
