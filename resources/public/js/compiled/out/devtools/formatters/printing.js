...
var len__42556__auto___54179 = arguments.length;
var i__42557__auto___54180 = (0);
while(true){
if((i__42557__auto___54180 < len__42556__auto___54179)){
args__42563__auto__.push((arguments[i__42557__auto___54180]));

var G__54181 = (i__42557__auto___54180 + (1));
i__42557__auto___54180 = G__54181;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__42564__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq54176){
var G__54177 = cljs.core.first.call(null,seq54176);
var seq54176__$1 = cljs.core.next.call(null,seq54176);
var G__54178 = cljs.core.first.call(null,seq54176__$1);
var seq54176__$2 = cljs.core.next.call(null,seq54176__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__54177,G__54178,seq54176__$2);
});
...
if(cljs.core.truth_((function (){var or__41385__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__42010__auto__,writer__42011__auto__,opt__42012__auto__){
return cljs.core._write.call(null,writer__42011__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__41373__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__41373__auto__){
var or__41385__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__41385__auto__)){
return or__41385__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__54182_SHARP_){
return !((cljs.core.meta.call(null,p1__54182_SHARP_) == null));
})))){
...
var map__54183 = opts;
var map__54183__$1 = ((((!((map__54183 == null)))?((((map__54183.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54183.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__54183):map__54183);
var markup_db = cljs.core.get.call(null,map__54183__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__41385__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e54187){var _e__53197__auto__ = e54187;
return false;
}})();
if(cljs.core.truth_(or__41385__auto__)){
return or__41385__auto__;
...
}catch (e54189){var _e__53197__auto__ = e54189;
return false;
}}
})())){
...
var _STAR_current_state_STAR_54191 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__54192 = opts;
var map__54192__$1 = ((((!((map__54192 == null)))?((((map__54192.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54192.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__54192):map__54192);
var markup_db = cljs.core.get.call(null,map__54192__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_54191;
}});
...
;
var temp__4655__auto___54196 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___54196)){
var managed_print_level_54197 = temp__4655__auto___54196;
var _STAR_print_level_STAR_54195_54198 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_54197;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_54195_54198,managed_print_level_54197,temp__4655__auto___54196,writer,opts,job_fn){
return (function (p1__54194_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__54194_SHARP_,null);
});})(_STAR_print_level_STAR_54195_54198,managed_print_level_54197,temp__4655__auto___54196,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_54195_54198;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1565798865762
