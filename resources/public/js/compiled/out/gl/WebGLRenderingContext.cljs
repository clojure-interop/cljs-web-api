...
(defn compressed-tex-image-2d
  ...
  [this & args]
  (apply (-> this .-compressedTexImage2D) (concat [this] args)))

(defn compressed-tex-image-3d
  "Method.
  ...
  See also: `https://developer.mozilla.org/en-US/docs/Web/API/WebGLRenderingContext/compressedTexImage2D`"
  [this & args]
  (apply (-> this .-compressedTexImage3D) (concat [this] args)))

(defn compressed-tex-sub-image-2d
  "Method.
...
(defn tex-parameterf
  ...
  [this & args]
  (apply (-> this .-texParameterf) (concat [this] args)))
...
(defn tex-parameteri
  ...
  See also: `https://developer.mozilla.org/en-US/docs/Web/API/WebGLRenderingContext/texParameter`"
  [this & args]
  (apply (-> this .-texParameteri) (concat [this] args)))

(defn tex-sub-image-2d
  "Method.
...
(defn uniform-matrix-2fv
  ...
  [this & args]
  (apply (-> this .-uniformMatrix2fv) (concat [this] args)))

(defn uniform-matrix-3fv
  "Method.
  ...
  See also: `https://developer.mozilla.org/en-US/docs/Web/API/WebGLRenderingContext/uniformMatrix`"
  [this & args]
  (apply (-> this .-uniformMatrix3fv) (concat [this] args)))

(defn uniform-matrix-4fv
  "Method.
  ...
  See also: `https://developer.mozilla.org/en-US/docs/Web/API/WebGLRenderingContext/uniformMatrix`"
  [this & args]
  (apply (-> this .-uniformMatrix4fv) (concat [this] args)))
...
(defn vertex-attrib-1f-1
  ...
  [this & args]
  (apply (-> this .-vertexAttrib1f1) (concat [this] args)))

(defn vertex-attrib-2f-2
  "Method.
  ...
  See also: `https://developer.mozilla.org/en-US/docs/Web/API/WebGLRenderingContext/vertexAttrib`"
  [this & args]
  (apply (-> this .-vertexAttrib2f2) (concat [this] args)))

(defn vertex-attrib-3f-3
  "Method.
  ...
  See also: `https://developer.mozilla.org/en-US/docs/Web/API/WebGLRenderingContext/vertexAttrib`"
  [this & args]
  (apply (-> this .-vertexAttrib3f3) (concat [this] args)))

(defn vertex-attrib-4f-4
  "Method.
  ...
  See also: `https://developer.mozilla.org/en-US/docs/Web/API/WebGLRenderingContext/vertexAttrib`"
  [this & args]
  (apply (-> this .-vertexAttrib4f4) (concat [this] args)))
