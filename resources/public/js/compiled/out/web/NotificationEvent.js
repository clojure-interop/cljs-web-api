...
goog.provide('web.NotificationEvent');
 ...
 */
web.NotificationEvent.constructor$ = NotificationEvent;
/**
 * Method.
 * 
 ...
 */
web.NotificationEvent.wait_until = (function web$NotificationEvent$wait_until(this$,promise){
 ...
 */
web.NotificationEvent.action = (function web$NotificationEvent$action(this$){
return this$.action();
});
/**
 * Property.
 ...
 *   See also: `https://developer.mozilla.org/en-US/docs/Web/API/NotificationEvent/action`
 */
web.NotificationEvent.set_action_BANG_ = (function web$NotificationEvent$set_action_BANG_(this$,val){
 ...
 */
web.NotificationEvent.notification = (function web$NotificationEvent$notification(this$){
 ...
 *   See also: `https://developer.mozilla.org/en-US/docs/Web/API/NotificationEvent/notification`
 */
web.NotificationEvent.set_notification_BANG_ = (function web$NotificationEvent$set_notification_BANG_(this$,val){
return (this$["notification"] = val);
});

//# sourceMappingURL=NotificationEvent.js.map?rel=1565798823532
