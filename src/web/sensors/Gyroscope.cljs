...
(def constructor
  ...
  The Gyroscope constructor creates a new `web.sensors.Gyroscope` object which provides on each reading the angular velocity of the device along all three axes.
